...
void PauseMenuComponent::onGui(){
    ...
    auto textSizeName = ImGui::CalcTextSize(playerName.c_str());

    ImGui::SetCursorPosX(GuiHelper::getInstance()->centerCursorX(textSizeName.x));
    ...
    auto textSizeEnemies = ImGui::CalcTextSize(textChar);
    ImGui::SetCursorPosX(GuiHelper::getInstance()->centerCursorX(textSizeEnemies.x));
    ImGui::Text(textChar);
